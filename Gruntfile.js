...
module.exports = function( grunt ) {
  ...
  grunt.initConfig( {
    projectJsDir: 'source/assets/js/client/project',
    thirdPartyJsDir: 'source/assets/js/client/thirdparty',
    outputJsDir: 'source/assets/js/client/output',
    closureDir: 'source/assets/js/client/thirdparty/closure-library',
    releaseDir: 'release',
    ...
    open: {
      dev: {
        path: 'http://dev.brd.com',
        app: 'Google Chrome'
      },
      release: {
        path: 'http://release.brd.com',
        app: 'Google Chrome'
      },
    },
      ...
      release: {
        files: [
          // includes files within path
          {
            ...
            src: [
              '**',
              '!assets/js/client/project/**',
              '!assets/js/client/output/brd-build.js',
              '!assets/js/client/output/brd-deps.js',
              '!assets/js/client/thirdparty/**',
              '!assets/styles/scss/**',
              '!assets/soy/**',
              '!assets/images/icons/*',
    ...
    closureBuilder: {
      options: {
        ...
        inputs: '<%= projectJsDir %>/brd.js',
      },

      main: {
        src: [ '<%= closureDir %>', '<%= projectJsDir %>' ],
        dest: '<%= outputJsDir %>/brd-build.js'
      }
    },
    ...
    closureCompiler: {
      ...
      main: {
        src: '<%= outputJsDir %>/brd-build.js',
        dest: '<%= outputJsDir %>/brd-compiled.js'
      }
    }
